...
describe('Types', () => {
  ...
  describe('TaskSchema', () => {
    ...
    it('should validate all task statuses', () => {
      const statuses = ['pending', 'claimed', 'in_progress', 'completed', 'failed', 'blocked', 'cancelled'];
  ...
  describe('TaskActivitySchema', () => {
    ...
    it('should validate all action types', () => {
      const actions = [
        'created', 'claimed', 'started', 'progress_update', 'completed',
        'failed', 'blocked', 'unblocked', 'reassigned', 'cancelled', 'commented',
      ];

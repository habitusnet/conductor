...
describe('Agent Profiles', () => {
  describe('DEFAULT_AGENT_PROFILES', () => {
    ...
    it('should have claude-sonnet profile', () => {
      ...
      expect(DEFAULT_AGENT_PROFILES['claude-sonnet'].provider).toBe('anthropic');
      expect(DEFAULT_AGENT_PROFILES['claude-sonnet'].model).toBe('claude-sonnet-4');
    });
    ...
    it('should have appropriate capabilities for each agent', () => {
      expect(DEFAULT_AGENT_PROFILES.claude.capabilities).toContain('typescript');
  ...
  describe('createAgentProfile', () => {
    ...
    it('should preserve organization binding', () => {
      ...
      expect(profile.organizationId).toBe('123e4567-e89b-12d3-a456-426614174000');
    });
  });
  ...
  describe('hasAllCapabilities', () => {
    ...
    it('should return true when agent has all required capabilities', () => {
      ...
      expect(hasAllCapabilities(testAgent, ['typescript', 'react', 'testing', 'nodejs'])).toBe(true);
    });

    it('should return false when agent is missing any capability', () => {
      expect(hasAllCapabilities(testAgent, ['typescript', 'python'])).toBe(false);

 ...
 */
export function getStateStore(d1?: D1Database): SQLiteStateStore | D1StateStore {
 ...
 */
export function getD1FromContext(context: { env?: { DB?: D1Database } }): D1Database | undefined {
 ...
 */
export function isD1Store(store: SQLiteStateStore | D1StateStore): store is D1StateStore {

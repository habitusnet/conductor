...
describe('CLI Commands', () => {
  ...
  describe('agent commands', () => {
    ...
    describe('agent register', () => {
      it('should register an agent', async () => {
        ...
        await program.parseAsync(['node', 'test', 'agent', 'register', '-i', 'claude']);
      ...
      it('should exit if not in a project', async () => {
        ...
        await expect(
          program.parseAsync(['node', 'test', 'agent', 'register', '-i', 'claude'])
  ...
  describe('task commands', () => {
    ...
    describe('task add', () => {
      it('should create a task with title', async () => {
        ...
        await program.parseAsync(['node', 'test', 'task', 'add', '-t', 'Test task']);
    ...
    describe('task list', () => {
      ...
      it('should filter tasks by status', async () => {
        ...
        await program.parseAsync(['node', 'test', 'task', 'list', '-s', 'pending']);
      ...
      it('should filter tasks by priority', async () => {
        ...
        await program.parseAsync(['node', 'test', 'task', 'list', '-p', 'critical']);
      ...
      it('should filter tasks by assigned agent', async () => {
        ...
        await program.parseAsync(['node', 'test', 'task', 'list', '-a', 'claude']);
      ...
      it('should display tasks with different statuses', async () => {
        ...
        mockStore.listTasks.mockReturnValue([
          ...
          { id: 't2', title: 'In Progress', status: 'in_progress', priority: 'medium' },
          { id: 't3', title: 'Completed', status: 'completed', priority: 'high' },
          { id: 't4', title: 'Failed', status: 'failed', priority: 'critical' },
          { id: 't5', title: 'Blocked', status: 'blocked', priority: 'medium', assignedTo: 'claude' },
        ]);
  ...
  describe('serve command', () => {
    ...
    it('should exit if not in a project', async () => {
      ...
      await expect(program.parseAsync(['node', 'test', 'serve'])).rejects.toThrow(
        'process.exit(1)'
      );
    });
  });
  ...
  describe('sandbox commands', () => {
    ...
    describe('sandbox create', () => {
      ...
      it('should handle sandbox creation failure', async () => {
        setupProjectConfig();
        mockSandboxManager.createSandbox.mockRejectedValue(new Error('API error'));
    ...
    describe('sandbox list', () => {
      ...
      it('should filter by status', async () => {
        ...
        await program.parseAsync(['node', 'test', 'sandbox', 'list', '-s', 'running']);
      ...
      it('should filter by agent', async () => {
        ...
        await program.parseAsync(['node', 'test', 'sandbox', 'list', '-a', 'claude']);
    ...
    describe('sandbox exec', () => {
      ...
      it('should show stderr output', async () => {
        ...
        await program.parseAsync(['node', 'test', 'sandbox', 'exec', 'sandbox-123', 'cmd']);
      ...
      it('should exit with non-zero code on failure', async () => {
        ...
        await expect(
          program.parseAsync(['node', 'test', 'sandbox', 'exec', 'sandbox-123', 'cmd'])
        ).rejects.toThrow('process.exit(1)');
      });

      it('should handle execution error', async () => {
        mockSandboxManager.executeCommand.mockRejectedValue(new Error('Sandbox not found'));
    ...
    describe('sandbox stop', () => {
      it('should stop a sandbox', async () => {
        ...
        await program.parseAsync(['node', 'test', 'sandbox', 'stop', 'sandbox-123']);

        expect(mockSandboxManager.stopSandbox).toHaveBeenCalledWith('sandbox-123');
        expect(consoleLogSpy).toHaveBeenCalled();
      });

      it('should handle stop failure', async () => {
        mockSandboxManager.stopSandbox.mockRejectedValue(new Error('Not found'));

        await expect(
          program.parseAsync(['node', 'test', 'sandbox', 'stop', 'sandbox-123'])
        ).rejects.toThrow('process.exit(1)');
      });
    });
  ...
  describe('spawn commands', () => {
    ...
    describe('spawn agent', () => {
      ...
      it('should handle spawn failure', async () => {
        setupProjectConfig();
        mockAgentRunner.startAgent.mockRejectedValue(new Error('E2B API error'));
    ...
    describe('spawn stop', () => {
      ...
      it('should handle stop failure', async () => {
        mockAgentRunner.stopAgent.mockRejectedValue(new Error('Agent not found'));
    ...
    describe('spawn exec', () => {
      ...
      it('should exit with non-zero code on failure', async () => {
        ...
        await expect(
          program.parseAsync(['node', 'test', 'spawn', 'exec', 'claude', 'cmd'])
        ).rejects.toThrow('process.exit(1)');
      });

      it('should handle execution error', async () => {
        mockAgentRunner.executeInAgent.mockRejectedValue(new Error('Agent not running'));

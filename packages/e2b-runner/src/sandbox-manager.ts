...
export class SandboxManager {
  ...
  constructor(options: E2BRunnerOptions = {}) {
    ...
    if (!this.options.apiKey) {
      console.warn('E2B API key not provided. Set E2B_API_KEY environment variable.');
    }
  }
   ...
   */
  listInstances(filter?: { status?: SandboxStatus; agentId?: string; projectId?: string }): SandboxInstance[] {
